...
import { addTag, setBold, setOl, setUl, setUnderline } from './event'

export default function Editor() {
  const [quill, setQuill] = useState(null)
  useEffect(() => {
    const quillFn = new Quill('#editor', {
      theme: 'snow',
      placeholder: '现在的想法是...',
      formats: ['blod', 'list', 'underline'],
    })
    setQuill(quillFn as any)
  }, [])
    ...
    <div className="editorWrapper">
      ...
      <div className="editor-menu">
        <div className="editor-menu__left flex">
          ...
          <span
            className="menu-item"
            onClick={() => addTag(quill as unknown as Quill)}
          >
            <svg
              data-v-3be209ba=""
              width="16px"
          ...
          <span
            className="menu-item"
            onClick={() => setUl(quill as unknown as Quill)}
          >
            <svg
              data-v-3be209ba=""
              width="16px"
          ...
          <span
            className="menu-item"
            onClick={() => setOl(quill as unknown as Quill)}
          >
            <svg
              data-v-3be209ba=""
              width="16px"
          ...
          <span
            className="menu-item"
            onClick={() => setBold(quill as unknown as Quill)}
          >
            <svg
              data-v-3be209ba=""
              width="16px"
          ...
          <span
            className="menu-item"
            onClick={() => setUnderline(quill as unknown as Quill)}
          >
            <svg
              data-v-3be209ba=""
              width="16px"
